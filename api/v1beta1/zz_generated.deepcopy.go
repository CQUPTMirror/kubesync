...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagerDeploy) DeepCopyInto(out *ManagerDeploy) {
	*out = *in
	in.DeployConfig.DeepCopyInto(&out.DeployConfig)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagerDeploy.
func (in *ManagerDeploy) DeepCopy() *ManagerDeploy {
	if in == nil {
		return nil
	}
	out := new(ManagerDeploy)
	in.DeepCopyInto(out)
	return out
}
